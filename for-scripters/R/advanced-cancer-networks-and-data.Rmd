...
If any of these checks fail, please refer to check-cytoscape-connection.R for more details: 
...
```{r}
brc.expr.network = getTableColumns('node','expr.mean')  # warning is expected here because not all nodes have data values
...
```{r}
brc.mut.network = getTableColumns('node','mut_count')  # warning is expected here
