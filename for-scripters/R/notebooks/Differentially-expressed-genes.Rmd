...
We already loaded the data in Example 1 above, into the dataframe `de.genes.full`. We can simply repeat the step of importing the data frame into the node table in Cytoscape:
...
Next, we will create a visualization of the imported data on the network, similarly to what we did earlier:
