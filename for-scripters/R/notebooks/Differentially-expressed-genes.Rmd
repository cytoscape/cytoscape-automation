...
setNodeShapeDefault("ELLIPSE", style.name = "de genes up")
lockNodeDimensions("TRUE", style.name = "de genes up")
setNodeSizeDefault("50", style.name = "de genes up")
setNodeColorDefault("#D3D3D3", style.name = "de genes up")
setNodeBorderWidthDefault("2", style.name = "de genes up")
setNodeBorderColorDefault("#616060", style.name = "de genes up")
setNodeLabelMapping("display name",style.name = "de genes up")
setNodeFontSizeDefault("14", style.name = "de genes up")
setEdgeOpacityDefault(100, style.name = "de genes up")
```
...
```{r}
commandsRun('string filter enrichment categories="GO Process", overlapCutoff = "0.5", removeOverlapping = "true"')
```
