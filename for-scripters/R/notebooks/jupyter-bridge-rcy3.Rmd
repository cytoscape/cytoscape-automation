...
Visit the [Jupyter Bridge RCy3 and Differentially Expressed Genes Network Analysis](https://github.com/cytoscape/cytoscape-automation/blob/master/for-scripters/R/notebooks/jupyter-bridge-rcy3.ipynb) for the detailed workflow.
